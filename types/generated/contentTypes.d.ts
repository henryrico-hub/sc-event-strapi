...
export interface ApiArticleScArticleSc extends Struct.CollectionTypeSchema {
  ...
  attributes: {
    art_body: Schema.Attribute.Blocks;
    author_sc: Schema.Attribute.Relation<
      'manyToOne',
      'api::author-sc.author-sc'
    >;
    claps: Schema.Attribute.Integer;
    createdAt: Schema.Attribute.DateTime;
    createdBy: Schema.Attribute.Relation<'oneToOne', 'admin::user'> &
      Schema.Attribute.Private;
...
export interface ApiAuthorScAuthorSc extends Struct.CollectionTypeSchema {
  ...
  attributes: {
    article_scs: Schema.Attribute.Relation<
      'oneToMany',
      'api::article-sc.article-sc'
    >;
...
export interface ApiEventCategoryEventCategory
  ...
  attributes: {
    ...
    createdBy: Schema.Attribute.Relation<'oneToOne', 'admin::user'> &
      Schema.Attribute.Private;
    description: Schema.Attribute.Text;
    event_category_fks: Schema.Attribute.Relation<
      'oneToMany',
      'api::event.event'
    >;
    locale: Schema.Attribute.String & Schema.Attribute.Private;
...
export interface ApiEventEvent extends Struct.CollectionTypeSchema {
  ...
  attributes: {
    author_desc: Schema.Attribute.String;
    author_sc: Schema.Attribute.Relation<
      'manyToOne',
      'api::author-sc.author-sc'
    >;
    category: Schema.Attribute.Relation<
      ...
      'api::event-category.event-category'
    >;
    city_state: Schema.Attribute.String;
    claps: Schema.Attribute.Integer &
      Schema.Attribute.Required &
    ...
    createdBy: Schema.Attribute.Relation<'oneToOne', 'admin::user'> &
      Schema.Attribute.Private;
    date_event: Schema.Attribute.DateTime;
    description1: Schema.Attribute.Text;
    description2: Schema.Attribute.Text;
    digital_payment: Schema.Attribute.Blocks;
    ...
    img_main: Schema.Attribute.Media<'images' | 'files' | 'videos' | 'audios'>;
    kit_delivery: Schema.Attribute.Blocks;
    locale: Schema.Attribute.String & Schema.Attribute.Private;
...
export interface ApiParticipantParticipant extends Struct.CollectionTypeSchema {
  ...
  attributes: {
    ...
    gender: Schema.Attribute.Enumeration<['Femenino', 'Masculino']>;
    locale: Schema.Attribute.String & Schema.Attribute.Private;
    localizations: Schema.Attribute.Relation<
      'oneToMany',
      'api::participant.participant'
...
declare module '@strapi/strapi' {
  export module Public {
    export interface ContentTypeSchemas {
      ...
      'api::article-sc.article-sc': ApiArticleScArticleSc;
